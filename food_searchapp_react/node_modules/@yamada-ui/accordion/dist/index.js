...
var AccordionPanel = (0, import_core3.forwardRef)(
  ({
    className,
    unmountOnExit,
    animationOpacity,
    ...
    const { styles } = useAccordionContext();
    const resolvedChildren = typeof children === "string" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { children }) : children;
      ...
      import_transitions.Collapse,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          import_core3.ui.div,
          {
            ...
            className: (0, import_utils3.cx)("ui-accordion__panel", className),
            __css: css,
...
var [AccordionItemProvider, useAccordionItemContext] = (0, import_utils4.createContext)({
  name: "AccordionItemContext",
  errorMessage: `useAccordionItemContext returned is 'undefined'. Seems you forgot to wrap the components in "<AccordionItem />"`
});
var AccordionItem = (0, import_core4.forwardRef)(
  ({ className, isDisabled = false, label, icon, children, ...rest }, ref) => {
    ...
    const isOpen = i !== -1 ? (0, import_utils4.isArray)(index) ? index.includes(i) : index === i : false;
    ...
    const onChange = (0, import_react2.useCallback)(
      (isOpen2) => {
        if (i === -1)
          return;
        if (isMultiple && (0, import_utils4.isArray)(index)) {
    ...
    const getLabelProps = (0, import_react2.useCallback)(
      (props = {}, ref2 = null) => ({
        ...props,
        ref: (0, import_utils4.mergeRefs)(register, ref2),
        type: "button",
        disabled: isDisabled,
        "aria-expanded": (0, import_utils4.ariaAttr)(isOpen),
        onClick: (0, import_utils4.handlerAll)(props.onClick, onClick),
        onFocus: (0, import_utils4.handlerAll)(props.onFocus, onFocus),
        onKeyDown: (0, import_utils4.handlerAll)(props.onKeyDown, onKeyDown)
      }),
    ...
    const [customAccordionLabel] = (0, import_utils4.findChildren)(validChildren, AccordionLabel);
    const [customAccordionPanel] = (0, import_utils4.findChildren)(validChildren, AccordionPanel);
    const cloneChildren = !(0, import_utils4.isEmpty)(validChildren) ? (0, import_utils4.omitChildren)(validChildren, AccordionLabel, AccordionPanel) : children;
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      AccordionItemProvider,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          ...
          {
            ref,
            className: (0, import_utils4.cx)("ui-accordion__item", className),
            "aria-expanded": (0, import_utils4.ariaAttr)(isOpen),
            __css: css,
            ...rest,
            children: [
              customAccordionLabel != null ? customAccordionLabel : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AccordionLabel, { children: cloneLabel }),
              customAccordionPanel != null ? customAccordionPanel : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AccordionPanel, { children: cloneChildren })
            ]
          }
        )
      }
