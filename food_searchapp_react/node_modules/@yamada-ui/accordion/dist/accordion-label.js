...
var accordion_label_exports = {};
__export(accordion_label_exports, {
  AccordionLabel: () => AccordionLabel
});
module.exports = __toCommonJS(accordion_label_exports);
...
var AccordionPanel = (0, import_core2.forwardRef)(
  ({
    className,
    unmountOnExit,
    animationOpacity,
    ...
    const resolvedChildren = typeof children === "string" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { children }) : children;
      ...
      import_transitions.Collapse,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          import_core2.ui.div,
          {
            ...
            className: (0, import_utils2.cx)("ui-accordion__panel", className),
            __css: css,
...
var AccordionLabel = (0, import_core4.forwardRef)(
  ({ className, icon: customIcon, children, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      import_core4.ui.button,
      {
        ...
        className: (0, import_utils4.cx)("ui-accordion__label", className),
        __css: css,
        children: [
          children,
          !iconHidden ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AccordionIcon, { children: (_a = cloneCustomIcon != null ? cloneCustomIcon : cloneSupplementIcon) != null ? _a : cloneGeneralIcon }) : null
        ]
      }
    );
  }
...
var AccordionIcon = ({
  ...
  if (children)
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ...
      {
        className: (0, import_utils4.cx)("ui-accordion__icon", className),
        __css: {
          display: "inline-flex",
...
//# sourceMappingURL=accordion-label.js.map