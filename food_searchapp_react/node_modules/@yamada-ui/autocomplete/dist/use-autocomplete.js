...
var useAutocomplete = ({
  ...
  const { id } = rest;
  const { "aria-readonly": _ariaReadonly, ...formControlProps } = (0, import_utils4.pickObject)(
    rest,
    import_form_control.formControlProperties
  );
  const [containerProps, inputProps] = (0, import_utils4.splitObject)(
    (0, import_utils4.omitObject)(rest, [...import_popover.popoverProperties, "onKeyDown", "onFocus"]),
    import_core4.layoutStyleProperties
  );
...
var useAutocompleteOptionGroup = ({
  ...
  const computedRest = (0, import_utils4.splitObject)(rest, import_core4.layoutStyleProperties);
  const getContainerProps = (0, import_react2.useCallback)(
    (props = {}, ref = null) => {
      const style = {
        border: "0px",
