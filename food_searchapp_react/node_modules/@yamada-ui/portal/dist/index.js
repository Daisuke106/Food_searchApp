...
var ContainerPortal = ({
  ...
  (0, import_utils3.useSafeLayoutEffect)(() => forceUpdate({}), []);
  ...
  return host && portal ? (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PortalProvider, { value: appendToParentPortal ? portal : null, children }),
    portal
  ) : null;
};
