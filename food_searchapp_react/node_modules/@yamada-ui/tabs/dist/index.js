...
var Tabs = (0, import_core.forwardRef)(
  ({ align = "start", ...props }, ref) => {
    const [styles, mergedProps] = (0, import_core.useMultiComponentStyle)("Tabs", {
      align,
      ...props
    });
    const {
    ...
    const [focusedIndex, setFocusedIndex] = (0, import_react.useState)(defaultIndex);
    ...
    const [customTabList] = (0, import_utils.findChildren)(validChildren, TabList);
    const [customTabPanels] = (0, import_utils.findChildren)(validChildren, TabPanels);
    const cloneTabs = (0, import_utils.pickChildren)(validChildren, Tab);
    const cloneTabPanels = (0, import_utils.pickChildren)(validChildren, TabPanel);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DescendantsContextProvider, { value: descendants, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      TabsProvider,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          ...
          {
            ref,
            className: (0, import_utils.cx)("ui-tabs", className),
            __css: css,
            ...rest,
            children: [
              customTabList != null ? customTabList : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabList, { children: cloneTabs }),
              customTabPanels != null ? customTabPanels : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabPanels, { children: cloneTabPanels })
            ]
          }
        )
      }
...
var Tab = (0, import_core3.forwardRef)(
  ({
    className,
    isDisabled,
    isFocusable,
    ...
    const rest = (0, import_use_clickable.useClickable)({
      ...
      clickOnEnter,
      clickOnSpace,
      onClick: (0, import_utils3.handlerAll)(props.onClick, () => setSelectedIndex(index))
    });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      ...
      {
        className: (0, import_utils3.cx)("ui-tabs__tab", className),
        __css: css,
        role: "tab",
        ...props,
        ...rest,
        ...
        "aria-selected": (0, import_utils3.ariaAttr)(isSelected),
        onPointerDown,
        onFocus: isDisabled ? void 0 : (0, import_utils3.handlerAll)(props.onFocus, onFocus),
        children: [
          children,
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_ripple.Ripple, { isDisabled: disableRipple || isDisabled, ...rippleProps })
        ]
      }
    );
  }
