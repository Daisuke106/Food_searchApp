...
var Tab = (0, import_core.forwardRef)(
  ({
    ...
    const rest = (0, import_use_clickable.useClickable)({
      ref: (0, import_utils.mergeRefs)(register, ref),
      isDisabled,
      isFocusable,
      clickOnEnter,
      clickOnSpace,
      onClick: (0, import_utils.handlerAll)(props.onClick, () => setSelectedIndex(index))
    });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      ...
      {
        className: (0, import_utils.cx)("ui-tabs__tab", className),
        __css: css,
        role: "tab",
        ...props,
        ...rest,
        ...
        "aria-selected": (0, import_utils.ariaAttr)(isSelected),
        onPointerDown,
        onFocus: isDisabled ? void 0 : (0, import_utils.handlerAll)(props.onFocus, onFocus),
        children: [
          children,
...
var Tabs = (0, import_core4.forwardRef)(
  ({ align = "start", ...props }, ref) => {
    ...
    const [focusedIndex, setFocusedIndex] = (0, import_react3.useState)(defaultIndex);
...
var TabList = (0, import_core5.forwardRef)(
  ({ className, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      ...
      {
        ref,
        className: (0, import_utils5.cx)("ui-tabs__list", className),
        role: "tablist",
        __css: css,
        ...tabListProps,
        ...rest,
