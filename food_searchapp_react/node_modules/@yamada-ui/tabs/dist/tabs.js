...
var [TabPanelProvider, useTabPanelContext] = (0, import_utils3.createContext)({});
var TabPanels = (0, import_core3.forwardRef)(
  ({ className, children, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      ...
      {
        ref,
        className: (0, import_utils3.cx)("ui-tabs__panels", className),
        __css: css,
        ...tabPanelsProps,
        ...rest,
...
var TabPanel = (0, import_core4.forwardRef)(
  ({ className, children, ...rest }, ref) => {
...
var [TabsProvider, useTabsContext] = (0, import_utils5.createContext)({
  name: "TabsContext",
...
var Tabs = (0, import_core5.forwardRef)(
  ({ align = "start", ...props }, ref) => {
    const [styles, mergedProps] = (0, import_core5.useMultiComponentStyle)("Tabs", {
      align,
      ...props
    });
    const {
    ...
    const [customTabList] = (0, import_utils5.findChildren)(validChildren, TabList);
    const [customTabPanels] = (0, import_utils5.findChildren)(validChildren, TabPanels);
    const cloneTabs = (0, import_utils5.pickChildren)(validChildren, Tab);
    const cloneTabPanels = (0, import_utils5.pickChildren)(validChildren, TabPanel);
    (0, import_react4.useEffect)(() => {
      if (index != null)
        setFocusedIndex(index);
    }, [index]);
    const css = { w: "100%", ...styles.container };
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(DescendantsContextProvider, { value: descendants, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      TabsProvider,
      {
        value: {
          focusedIndex,
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          ...
          {
            ref,
            className: (0, import_utils5.cx)("ui-tabs", className),
            __css: css,
            ...rest,
            children: [
