...
var [TabPanelProvider, useTabPanelContext] = (0, import_utils2.createContext)({});
var TabPanels = (0, import_core2.forwardRef)(
  ({ className, children, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      ...
      {
        ref,
        className: (0, import_utils2.cx)("ui-tabs__panels", className),
        __css: css,
        ...tabPanelsProps,
        ...rest,
...
var TabPanel = (0, import_core3.forwardRef)(
  ({ className, children, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      ...
      {
        ref,
        className: (0, import_utils3.cx)("ui-tabs__panel", className),
        role: "tabpanel",
        __css: css,
        ...rest,
        hidden: !isSelected,
...
var [TabsProvider, useTabsContext] = (0, import_utils4.createContext)({
  name: "TabsContext",
  errorMessage: `useTabsContext returned is 'undefined'. Seems you forgot to wrap the components in "<Tabs />"`
});
var Tabs = (0, import_core4.forwardRef)(
  ({ align = "start", ...props }, ref) => {
    const [styles, mergedProps] = (0, import_core4.useMultiComponentStyle)("Tabs", {
      align,
      ...props
    });
    const {
    ...
    const [focusedIndex, setFocusedIndex] = (0, import_react4.useState)(defaultIndex);
    ...
    const [customTabList] = (0, import_utils4.findChildren)(validChildren, TabList);
    const [customTabPanels] = (0, import_utils4.findChildren)(validChildren, TabPanels);
    const cloneTabs = (0, import_utils4.pickChildren)(validChildren, Tab);
    const cloneTabPanels = (0, import_utils4.pickChildren)(validChildren, TabPanel);
    (0, import_react4.useEffect)(() => {
      if (index != null)
        setFocusedIndex(index);
    }, [index]);
    const css = { w: "100%", ...styles.container };
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DescendantsContextProvider, { value: descendants, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      TabsProvider,
      {
        value: {
          focusedIndex,
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          ...
          {
            ref,
            className: (0, import_utils4.cx)("ui-tabs", className),
            __css: css,
            ...rest,
            children: [
              customTabList != null ? customTabList : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TabList, { children: cloneTabs }),
              customTabPanels != null ? customTabPanels : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TabPanels, { children: cloneTabPanels })
            ]
          }
        )
      }
...
var Tab = (0, import_core5.forwardRef)(
  ({
    className,
    isDisabled,
    isFocusable,
    ...
    const rest = (0, import_use_clickable.useClickable)({
      ref: (0, import_utils5.mergeRefs)(register, ref),
      isDisabled,
      isFocusable,
      clickOnEnter,
      clickOnSpace,
      onClick: (0, import_utils5.handlerAll)(props.onClick, () => setSelectedIndex(index))
    });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      ...
      {
        className: (0, import_utils5.cx)("ui-tabs__tab", className),
        __css: css,
        role: "tab",
        ...props,
        ...rest,
        ...
        "aria-selected": (0, import_utils5.ariaAttr)(isSelected),
        onPointerDown,
        onFocus: isDisabled ? void 0 : (0, import_utils5.handlerAll)(props.onFocus, onFocus),
        children: [
          children,
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_ripple.Ripple, { isDisabled: disableRipple || isDisabled, ...rippleProps })
        ]
      }
    );
  }
