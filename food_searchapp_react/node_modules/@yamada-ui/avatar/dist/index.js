...
var Avatar = (0, import_core2.forwardRef)((props, ref) => {
  const [styles, mergedProps] = (0, import_core2.useMultiComponentStyle)("Avatar", props);
  const {
    className,
    src,
    srcSet,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AvatarProvider, { value: styles, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
...
var AvatarImage = ({
  ...
  name,
  loading,
  icon = /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AvatarIcon, {}),
  ignoreFallback,
  crossOrigin,
  referrerPolicy
}) => {
...
var AvatarGroup = (0, import_core3.forwardRef)((props, ref) => {
  const [styles] = (0, import_core3.useMultiComponentStyle)("Avatar", props);
  const {
    className,
    max,
    borderColor,
    ...
    children,
    ...rest
  } = (0, import_core3.omitThemeProps)(props);
  let validChildren = (0, import_utils2.getValidChildren)(children);
  const excess = !(0, import_utils2.isUndefined)(max) ? validChildren.length - max : 0;
  validChildren = !(0, import_utils2.isUndefined)(max) ? validChildren.slice(0, max) : validChildren;
  ...
  const cloneChildren = validChildren.map(
    (child, i) => {
      ...
      return (0, import_react2.cloneElement)(
        child,
        (0, import_utils2.filterUndefined)({
          marginEnd: !i ? 0 : gap,
          size: props.size,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    ...
    {
      ref,
      className: (0, import_utils2.cx)("ui-avatar-group", className),
      __css: {
        display: "flex",
      ...
      ...rest,
      children: [
        excess > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
...
var AvatarBadge = (0, import_core4.forwardRef)(
  ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      ...
      {
        ref,
        className: (0, import_utils3.cx)("ui-avatar__badge", className),
        boxSize,
        __css: css,
        ...rest,
        children: [
