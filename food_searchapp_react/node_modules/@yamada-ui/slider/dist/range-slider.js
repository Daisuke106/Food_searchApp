...
var useRangeSlider = ({
  ...
  const [computedValues, setValues] = (0, import_use_controllable_state.useControllableState)({
    value: valueProp,
    defaultValue,
    onChange
  });
  ...
  const values = computedValues.map(
    (value) => (0, import_utils.clampNumber)(value, min, max)
  );
  ...
  const thumbPercents = thumbValues.map(
    (value) => (0, import_utils.valueToPercent)(value, min, max)
  );
  const valueBounds = [
  ...
  const thumbSizes = (0, import_use_size.useSizes)({
    getNodes: () => {
      var _a;
  ...
  const getThumbId = (0, import_react.useCallback)((i) => `slider-thumb-${id}-${i}`, [id]);
  const getInputId = (0, import_react.useCallback)((i) => `slider-input-${id}-${i}`, [id]);
  const getMarkerId = (0, import_react.useCallback)(
  ...
  const constrain = (0, import_react.useCallback)(
    (i, value) => {
      ...
      value = parseFloat((0, import_utils.roundNumberToStep)(value, min2, oneStep));
      value = (0, import_utils.clampNumber)(value, min2, max2);
  ...
  const getInputProps = (0, import_react.useCallback)(
    ({ index: i, ...props2 }, ref = null) => ({
      ...
      id: getInputId(i),
      type: "hidden",
      name: (0, import_utils.isArray)(name) ? name[i] : `${name}-${i}`,
      value: values[i],
      required,
      disabled,
      readOnly
  ...
  const getMarkProps = (0, import_react.useCallback)(
    (props2, ref = null) => {
      ...
      return {
        ...
        "data-highlighted": (0, import_utils.dataAttr)(
  ...
  const getThumbProps = (0, import_react.useCallback)(
    ({ index: i, ...props2 }, ref = null) => {
      ...
      return {
        ...
        "aria-valuemax": max,
        "aria-valuenow": value,
        "data-active": (0, import_utils.dataAttr)(
...
var [RangeSliderProvider, useRangeSliderContext] = (0, import_utils.createContext)({
...
var RangeSlider = (0, import_core.forwardRef)((props, ref) => {
  const [styles, mergedProps] = (0, import_core.useMultiComponentStyle)("RangeSlider", props);
  const {
    className,
    children,
    inputProps,
  ...
  const [customRangeSliderTrack] = (0, import_utils.findChildren)(validChildren, RangeSliderTrack);
  const [customRangeSliderStartThumb] = (0, import_utils.findChildren)(
    validChildren,
    RangeSliderStartThumb
  );
  const [customRangeSliderEndThumb] = (0, import_utils.findChildren)(
    validChildren,
    RangeSliderEndThumb
  );
  const hasRangeSliderStartThumb = (0, import_utils.includesChildren)(
    validChildren,
    RangeSliderStartThumb
  );
  const hasRangeSliderEndThumb = (0, import_utils.includesChildren)(
    validChildren,
    RangeSliderEndThumb
  );
  const cloneChildren = !(0, import_utils.isEmpty)(validChildren) ? (0, import_utils.omitChildren)(
    validChildren,
    RangeSliderTrack,
    RangeSliderStartThumb,
    RangeSliderEndThumb
    ...
    RangeSliderProvider,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        import_core.ui.div,
        {
          ...
          children: [
            customRangeSliderTrack != null ? customRangeSliderTrack : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RangeSliderTrack, {}),
            cloneChildren,
            customRangeSliderStartThumb != null ? customRangeSliderStartThumb : !hasRangeSliderStartThumb ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RangeSliderStartThumb, {}) : null,
            customRangeSliderEndThumb != null ? customRangeSliderEndThumb : !hasRangeSliderEndThumb ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RangeSliderEndThumb, {}) : null
          ]
        }
      )
    }
...
var RangeSliderTrack = (0, import_core.forwardRef)(
  ({ className, children, filledTrackProps, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_core.ui.div,
      {
        ...
        children: children != null ? children : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RangeSliderFilledTrack, { ...filledTrackProps })
      }
    );
  }
);
var RangeSliderFilledTrack = (0, import_core.forwardRef)(({ className, ...rest }, ref) => {
...
var RangeSliderMark = (0, import_core.forwardRef)(
  ({ className, ...rest }, ref) => {
...
var RangeSliderThumb = (0, import_core.forwardRef)(({ className, index, children, ...rest }, ref) => {
  const {
    styles,
    thumbProps,
    thumbColor,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    import_core.ui.div,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core.ui.input, { ...getInputProps({ ...inputProps, index }, ref) }),
        children != null ? children : propChildren
      ]
    }
  );
});
var RangeSliderStartThumb = (0, import_core.forwardRef)(
  (rest, ref) => {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RangeSliderThumb, { ref, index: 0, ...rest });
  }
);
var RangeSliderEndThumb = (0, import_core.forwardRef)(
  (rest, ref) => {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RangeSliderThumb, { ref, index: 1, ...rest });
  }
);
