...
var Select = (0, import_core4.forwardRef)((props, ref) => {
  ...
  if (!validChildren.length && items.length) {
    computedChildren = items.map((item, i) => {
      if ("value" in item) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Option, { value, ...props2, children: label }, i);
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          OptionGroup,
          {
            ...
            ...props2,
            children: items2.map(({ label: label2, value, ...props3 }, i2) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Option, { value, ...props3, children: label2 }, i2))
          },
          i
        );
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SelectDescendantsContextProvider, { value: descendants, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    SelectProvider,
    {
      value: { ...rest, placeholder, placeholderInOptions, styles },
      children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_popover2.Popover, { ...getPopoverProps(), children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        import_core4.ui.div,
        {
          className: (0, import_utils4.cx)("ui-select", className),
          __css: css,
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
              import_core4.ui.div,
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_popover2.PopoverTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SelectField, { h, minH, ...getFieldProps({}, ref) }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SelectIcon, { ...iconProps, ...formControlProps })
                ]
              }
            ),
            !isEmpty ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_portal.Portal, { ...portalProps, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(SelectList, { ...listProps, children: [
              !!placeholder && placeholderInOptions ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Option, { children: placeholder }) : null,
...
var SelectField = (0, import_core4.forwardRef)(
  ({ className, isTruncated = true, lineClamp, h, minH, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      ...
      {
        ref,
        className: (0, import_utils4.cx)("ui-select__field", className),
        __css: css,
        ...rest,
...
var MultiSelect = (0, import_core5.forwardRef)((props, ref) => {
  const [styles, mergedProps] = (0, import_core5.useMultiComponentStyle)("MultiSelect", props);
  let {
    className,
    defaultValue = [],
    component,
  ...
  if (!validChildren.length && items.length) {
    computedChildren = items.map((item, i) => {
      if ("value" in item) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Option, { value: value2, ...props2, children: label }, i);
      } else if ("items" in item) {
        const { label, items: items2 = [], ...props2 } = item;
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          OptionGroup,
          {
            label: label != null ? label : "",
            ...props2,
            children: items2.map(({ label: label2, value: value2, ...props3 }, i2) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Option, { value: value2, ...props3, children: label2 }, i2))
          },
          i
        );
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SelectDescendantsContextProvider, { value: descendants, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SelectProvider, { value: { ...rest, value, placeholder, styles }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_popover3.Popover, { ...getPopoverProps(), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    import_core5.ui.div,
    {
      className: (0, import_utils5.cx)("ui-multi-select", className),
      __css: css,
      ...getContainerProps(containerProps),
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          import_core5.ui.div,
          {
            ...
            __css: { position: "relative", ...styles.inner },
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_popover3.PopoverTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                MultiSelectField,
                {
                  component,
                  separator,
              ...
              isClearable && value.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                SelectClearIcon,
                {
                  ...clearIconProps,
                  onClick: (0, import_utils5.handlerAll)(clearIconProps == null ? void 0 : clearIconProps.onClick, onClear),
                  ...formControlProps
                }
              ) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SelectIcon, { ...iconProps, ...formControlProps })
            ]
          }
        ),
        !isEmpty ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_portal2.Portal, { ...portalProps, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SelectList, { ...listProps, children: children != null ? children : computedChildren }) }) : null
      ]
    }
  ) }) }) });
});
var MultiSelectField = (0, import_core5.forwardRef)(
  ({
    className,
    component,
    separator = ",",
    ...
    const cloneChildren = (0, import_react3.useMemo)(() => {
      if (!(label == null ? void 0 : label.length))
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_core5.ui.span, { lineClamp, children: placeholder });
      if (component) {
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_core5.ui.span, { isTruncated, lineClamp, children: label.map((label2, index) => {
          const onRemove = (e) => {
            e.stopPropagation();
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_core5.ui.span, { isTruncated, lineClamp, children: label.map((value2, index) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ...
      {
        ref,
        className: (0, import_utils5.cx)("ui-multi-select__field", className),
        __css: css,
...
var OptionGroup = (0, import_core6.forwardRef)(
  ({ className, color, h, height, minH, minHeight, children, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      import_core6.ui.li,
      {
        className: (0, import_utils6.cx)("ui-select__item", "ui-select__item--group", className),
...
var Option = (0, import_core7.forwardRef)(
  ({ className, icon, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      import_core7.ui.li,
      {
        className: (0, import_utils7.cx)("ui-select__item", className),
        __css: css,
        ...getOptionProps(),
        children: [
          icon !== null ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(OptionIcon, { opacity: isSelected ? 1 : 0, children: icon || /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CheckIcon, {}) }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_core7.ui.span, { style: { flex: 1 }, "data-label": true, children })
        ]
      }
    );
  }
);
var OptionIcon = (0, import_core7.forwardRef)(
  ({ className, ...rest }, ref) => {
    const { styles } = useSelectContext();
    const css = {
      flexShrink: 0,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      ...
      {
        ref,
        className: (0, import_utils7.cx)("ui-select__item__icon", className),
        __css: css,
        ...rest
      }
    );
