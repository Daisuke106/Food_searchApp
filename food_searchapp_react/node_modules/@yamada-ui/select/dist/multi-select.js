...
var MultiSelect = (0, import_core6.forwardRef)((props, ref) => {
  const [styles, mergedProps] = (0, import_core6.useMultiComponentStyle)("MultiSelect", props);
  let {
    className,
    defaultValue = [],
    component,
  ...
  if (!validChildren.length && items.length) {
    computedChildren = items.map((item, i) => {
      if ("value" in item) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Option, { value: value2, ...props2, children: label }, i);
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          OptionGroup,
          {
            ...
            ...props2,
            children: items2.map(({ label: label2, value: value2, ...props3 }, i2) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Option, { value: value2, ...props3, children: label2 }, i2))
          },
          i
        );
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SelectDescendantsContextProvider, { value: descendants, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SelectProvider, { value: { ...rest, value, placeholder, styles }, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_popover2.Popover, { ...getPopoverProps(), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    import_core6.ui.div,
    {
      className: (0, import_utils6.cx)("ui-multi-select", className),
      __css: css,
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          import_core6.ui.div,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_popover2.PopoverTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                MultiSelectField,
                {
                  component,
                  separator,
              ...
              isClearable && value.length ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                SelectClearIcon,
                {
                  ...clearIconProps,
                  onClick: (0, import_utils6.handlerAll)(clearIconProps == null ? void 0 : clearIconProps.onClick, onClear),
                  ...formControlProps
                }
        ...
        !isEmpty ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_portal.Portal, { ...portalProps, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(SelectList, { ...listProps, children: children != null ? children : computedChildren }) }) : null
      ]
    }
  ) }) }) });
});
var MultiSelectField = (0, import_core6.forwardRef)(
  ({
    className,
    component,
    separator = ",",
    ...
    const cloneChildren = (0, import_react3.useMemo)(() => {
      if (!(label == null ? void 0 : label.length))
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_core6.ui.span, { lineClamp, children: placeholder });
      if (component) {
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_core6.ui.span, { isTruncated, lineClamp, children: label.map((label2, index) => {
          const onRemove = (e) => {
            e.stopPropagation();
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_core6.ui.span, { isTruncated, lineClamp, children: label.map((value2, index) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      ...
      {
        ref,
        className: (0, import_utils6.cx)("ui-multi-select__field", className),
        __css: css,
