...
var CheckboxGroup = (0, import_react.forwardRef)(
  ({
    ...
    const { isRequired, isReadOnly, isDisabled, isInvalid, ...rest } = (0, import_form_control.useFormControl)(computedProps);
...
var useCheckbox = ({
  ...
  const [{ "aria-readonly": _ariaReadonly, ...formControlProps }, rest] = (0, import_utils2.splitObject)(computedProps, import_form_control2.formControlProperties);
...
var Checkbox = (0, import_react2.forwardRef)(
  (props, ref) => {
    ...
    const cloneIcon = (0, import_react2.cloneElement)(customIcon != null ? customIcon : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CheckboxIcon, {}), {
      __css: {
