...
var Rating = (0, import_core3.forwardRef)((props, ref) => {
  const [styles, mergedProps] = (0, import_core3.useMultiComponentStyle)("Rating", props);
  const { className, ...computedProps } = (0, import_core3.omitThemeProps)(mergedProps);
  const { getContainerProps, children, ...rest } = useRating(computedProps);
  const css = { display: "flex", ...styles.container };
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RatingProvider, { value: { styles, ...rest }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    import_core3.ui.div,
    {
      className: (0, import_utils4.cx)("ui-rating", className),
      __css: css,
