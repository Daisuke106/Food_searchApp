...
// src/tbody.tsx
var tbody_exports = {};
__export(tbody_exports, {
  Tbody: () => Tbody
});
module.exports = __toCommonJS(tbody_exports);
...
var NativeTable = (0, import_core.forwardRef)(
  (props, ref) => {
    const [styles, mergedProps] = (0, import_core.useMultiComponentStyle)("NativeTable", props);
...
var Tbody = (0, import_core2.forwardRef)(
  ({ className, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      ...
      {
        ref,
        className: (0, import_utils2.cx)("ui-table__tbody", className),
        __css: css,
        ...rest
      }
    );
