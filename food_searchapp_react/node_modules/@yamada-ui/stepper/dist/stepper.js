...
var Step = (0, import_core.forwardRef)(
  ({ className, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StepProvider, { value: { index, status, isFirst, isLast }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      import_core.ui.div,
      {
...
var StepTitle = (0, import_core2.forwardRef)(
  ({ className, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      ...
      {
        ref,
        className: (0, import_utils3.cx)("ui-step__title", className),
        "data-status": status,
        __css: css,
        ...rest
      }
...
var StepDescription = (0, import_core3.forwardRef)(
  ({ className, ...rest }, ref) => {
    const { styles } = useStepperContext();
    const { status } = useStepContext();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      ...
      {
        ref,
        className: (0, import_utils4.cx)("ui-step__description", className),
        "data-status": status,
        __css: css,
        ...rest
      }
...
var StepSeparator = (0, import_core4.forwardRef)(
  ({ className, ...rest }, ref) => {
    const { orientation, showLastSeparator, styles } = useStepperContext();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ...
      {
        ref,
        className: (0, import_utils5.cx)("ui-step__separator", className),
        role: "separator",
        "data-orientation": orientation,
        "data-status": status,
        __css: css,
...
var StepStatus = (0, import_core5.forwardRef)(
  ({
    className,
    ...
    switch (status) {
      case "complete":
        component = (0, import_utils6.runIfFunc)(complete, props);
        break;
      case "incomplete":
        component = (0, import_utils6.runIfFunc)(incomplete, props);
        break;
      case "active":
        component = (0, import_utils6.runIfFunc)(active, props);
        break;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      ...
      {
        ref,
        className: (0, import_utils6.cx)("ui-step__status", className),
        "data-status": status,
        __css: css,
        ...rest,
        children: component ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: component }) : null
      }
    );
  }
);
var StepNumber = (0, import_core5.forwardRef)(
  ({ className, children, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      ...
      {
        ref,
        className: (0, import_utils6.cx)("ui-step__number", className),
        "data-status": status,
        __css: css,
        ...rest,
...
var StepIcon = (0, import_core5.forwardRef)(
  ({ className, ...rest }, ref) => {
    const { styles } = useStepperContext();
    const { status } = useStepContext();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      import_icon.Icon,
      {
        ref,
        as,
        className: (0, import_utils6.cx)("ui-step__icon", className),
        "data-status": status,
        __css: css,
        ...rest
      }
...
var Stepper = (0, import_core6.forwardRef)((props, ref) => {
  const [styles, mergedProps] = (0, import_core6.useMultiComponentStyle)("Stepper", props);
  const { className, steps, children, ...computedProps } = (0, import_core6.omitThemeProps)(mergedProps);
    ...
    if (hasChildren) {
      ...
      return steps == null ? void 0 : steps.map(
        ({
          ...
          separatorProps,
          ...rest2
        }, index) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Step, { ...rest2, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StepStatus, { ...statusProps }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_core6.ui.div, { flexShrink: 0, children: [
            title ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StepTitle, { ...titleProps, children: title }) : null,
            description ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StepDescription, { ...descriptionProps, children: description }) : null
          ] }),
          hasSeparator ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StepSeparator, { ...separatorProps }) : null
        ] }, index)
      );
    }
  }, [children, steps]);
  const css = { ...styles.stepper };
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StepperDescendantsContextProvider, { value: descendants, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(StepperProvider, { value: { ...rest, styles }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
    import_core6.ui.div,
    {
      className: (0, import_utils7.cx)("ui-stepper", className),
      __css: css,
