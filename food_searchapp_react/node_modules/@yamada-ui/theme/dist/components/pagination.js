  ...
  variants: {
    solid: ({ colorScheme: c = "primary" }) => ({
      item: {
        ...
        _selected: {
          ...
          borderColor: (0, import_utils.isGray)(c) ? [`${c}.50`, `${c}.700`] : [(0, import_utils.isAccessible)(c) ? `${c}.400` : `${c}.500`, `${c}.600`],
    ...
    ghost: ({ theme: t, colorMode: m, colorScheme: c = "primary" }) => {
      return {
        item: {
          _selected: {
            bg: (0, import_utils.isGray)(c) ? void 0 : "transparent",
            fontWeight: "semibold",
            color: (0, import_utils.isGray)(c) ? ["blackAlpha.800", "whiteAlpha.700"] : [`${c}.600`, `${c}.500`]
          },
          _hover: {
          ...
          _active: {
            bg: (0, import_utils.isGray)(c) ? [`${c}.300`, `whiteAlpha.300`] : [`${c}.200`, (0, import_utils.transparentizeColor)(`${c}.200`, 0.24)(t, m)]
          }
        }
      };
    },
